...
- избранные проекты и отзывы об участниках команды;
- административная модерация проектов, справочников и отзывов;
...
| Роль             | Возможности                                                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Гость            | Просматривает опубликованные проекты, открытые роли, доступных специалистов, справочники и опубликованные отзывы.                                 |
| Специалист       | Настраивает профиль и доступность, ищет проекты, добавляет их в избранное, отправляет и отменяет отклики, отвечает на приглашения.                |
...
| Администратор    | Управляет всеми сущностями, видит скрытые и непубличные записи, модерирует отзывы и может выполнять действия независимо от владельца объекта.     |
...
| MailHog             | <http://127.0.0.1:8025>        | Просмотр локальных email-сообщений       |
...
| `/api/reviews/` | Опубликованные отзывы доступны всем; автор и владелец проекта видят связанные непубличные | Автор управляет своим отзывом; публикация и модерация — администратор |
